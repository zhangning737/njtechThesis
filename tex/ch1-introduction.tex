...
该南京工业大学学位论文模板\texttt{njtechThesis}文档类的基础架构为ctexbook文档类。当前\texttt{njtechThesis}模板基本满足最新的南京工业大学学位论文撰写要求和封面设定（注意：部分审阅人会挑剔字体等细节问题）。模板提供了pdflatex 或xelatex （默认，推荐） 编译方式，完美地支持中文书签、中文渲染、中文粗体显示、拷贝pdf中的文本到其他文本编辑器等特性，此外，对模板的文档结构进行了精心设计，撰写了编译脚本提高模板的易用性和使用效率。
...
\texttt{njtechThesis}宏包可以在目前大多数的\TeX{}系统中使用，例如C\TeX{}、MiK\TeX{}、te\TeX{}、\TeX{}live。考虑到大多数用户将是Windows使用者，推荐安装最新的\TeX{}live套装，\TeX{}live套装中包含了本模板中出的各类宏包，用户无需额外的设置即可使用。
...
%% ++++++++++++++++++++++++++++++++++++++
\begin{enumerate}
\item texlive-2025(MacTeX on Mac OSX);

\item texlive-2025(Windows OS)。
