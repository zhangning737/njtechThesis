...
%%
\documentclass{njtechThesis}% thesis template of the Nanjing Tech Univ
%% Options:
...
%%
\setmainfont{XITS}  %set english letter font, look like times 
\usepackage{url}
...
%
\usepackage[list=off,font=rm]{bicaption}
\DeclareCaptionFont{myfont}{\fontsize{10pt}{11pt}\songti}
\DeclareCaptionFont{myfont2}{\fontsize{10pt}{11pt}\rm}
\captionsetup[figure][bi-second]{name=Fig.,font=myfont2} %设置图的英文编号前缀
\captionsetup[table][bi-second]{name=Table,font=myfont2} %设置表的英文编号前缀
